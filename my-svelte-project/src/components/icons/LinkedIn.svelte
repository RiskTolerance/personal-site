<script>
	let primaryColor = '#F4FFF4';
	let secondaryColor = '#272727';
	let handleMouseOver = () => {
		secondaryColor = '#e3a73e';
	};
	let handleMouseOut = () => {
...
<div id="btn" on:mouseover={handleMouseOver} on:mouseout={handleMouseOut}>
	<a href="https://www.linkedin.com/in/isaac-druin/" target="_blank" rel=”noreferrer” aria-label="Linkedin link">
